...
export default function Footer() {
  return (
    <footer style={{ background: "var(--color-surface-dim)" }}>
      {/* Gold accent line */}
      <div 
        className="h-[1px]" 
        style={{ 
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-12 py-16">
        <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="space-y-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="block text-sm font-light transition-all duration-400"
                  style={{ 
          ...
          <div>
            ...
            >
              <div className="flex justify-between" style={{ color: "var(--color-on-surface-variant)" }}>
                <span>Monday</span>
                <span>10 – 6</span>
              </div>
