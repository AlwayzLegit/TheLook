    ...
    <footer className="bg-charcoal relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-12 py-18 relative">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-5 mt-6">
              <a href="https://www.instagram.com/thelookhairsalon/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/40 hover:text-gold transition-all duration-300 hover:-translate-y-0.5">
              ...
              <a href="https://www.facebook.com/p/The-Look-Hair-Salon-100046925091028/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/40 hover:text-gold transition-all duration-300 hover:-translate-y-0.5">
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385h-3.047v-3.47h3.047v-2.642c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953h-1.514c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385c5.738-.9 10.126-5.864 10.126-11.854z" /></svg>
              </a>
              <a href="https://www.yelp.com/biz/the-look-hair-salon-glendale" target="_blank" rel="noopener noreferrer" aria-label="Yelp" className="text-white/40 hover:text-gold transition-all duration-300 hover:-translate-y-0.5">
            ...
            <div className="space-y-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="block text-white/55 hover:text-gold text-sm font-body font-light transition-all duration-300 hover:translate-x-1"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="text-sm font-body font-light space-y-2.5 text-white/55">
              <p>919 South Central Ave Suite #E</p>
              <p>Glendale, CA 91204</p>
              <p className="pt-3">
                <a href="tel:+18186625665" className="hover:text-gold transition-colors duration-300 text-white/70">
                  (818) 662-5665
                </a>
              </p>
              <p>
        ...
        <div className="border-t border-white/8 mt-14 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/25 text-[10px] font-body tracking-wider">
