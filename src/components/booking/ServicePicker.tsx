...
interface Service {
  id: string;
  category: string;
  // Subcategory tagging (Unisex / Women's / Men's) is still ingested
  // from the API for forward compatibility, but the booking flow no
  // longer renders sub-headers — owner asked to keep every category as
  // a flat list so customers don't have to think about which tier they
  // belong to. The marketing site's HaircutsGallery still splits.
