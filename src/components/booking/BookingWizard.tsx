...
// The interactive multi-step booking wizard. This is a client island:
// app/book/page.tsx is a Server Component that renders indexable
// content + JSON-LD and mounts this under a <Suspense> boundary. That
// split is what lets /book prerender (so Next.js no longer auto-
// attaches X-Robots-Tag: noindex to the route) while keeping the full
// client-stateful flow — useSearchParams deep-link prefill, the
// ?step= URL sync, Stripe, etc. — completely unchanged. Moved here
// verbatim from app/book/page.tsx; no logic changes.
