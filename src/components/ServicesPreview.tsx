        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
          {highlights.map((s, i) => (
            <AnimatedSection key={s.name} delay={i * 0.08}>
              <div className="relative overflow-hidden border border-navy/6 hover:border-gold/30 transition-all duration-500 group hover:shadow-[0_8px_30px_rgba(196,162,101,0.1)] hover:-translate-y-1 bg-white">
                {/* Service Image */}
